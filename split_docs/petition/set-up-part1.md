# Source: https://docs.civicrm.org/user/en/latest/petition/set-up/

Here's how you can reformat the provided page using the Diátaxis framework:
...
This guide is structured as a **Guide** because it provides step-by-step instructions to help users achieve a specific goal—setting up a petition in CiviCRM. The content is suitable for a **Basic** level, as it covers foundational steps without requiring advanced knowledge. If the content becomes too complex or covers multiple distinct topics, consider splitting it into separate pages. 

For example, if you have additional advanced setup options or troubleshooting tips, you might create a separate page for those topics.